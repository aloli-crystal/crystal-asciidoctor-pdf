...
module AsciicrystalPDF
  ...
  # Équivalent du ThemeLoader d'asciicrystal-pdf Ruby.
  module ThemeLoader
    ...
    private def self.apply(theme : Theme, yaml : YAML::Any) : Nil
      ...
      yaml.as_h.each do |key, value|
        ...
        when "header_recto_left"   then theme.header_recto_left = value.as_s? || theme.header_recto_left
        when "header_recto_center" then theme.header_recto_center = value.as_s? || theme.header_recto_center
        when "header_recto_right"  then theme.header_recto_right = value.as_s? || theme.header_recto_right
        when "header_verso_left"   then theme.header_verso_left = value.as_s? || theme.header_verso_left
        when "header_verso_center" then theme.header_verso_center = value.as_s? || theme.header_verso_center
        when "header_verso_right"  then theme.header_verso_right = value.as_s? || theme.header_verso_right
        ...
        when "footer_recto_left"   then theme.footer_recto_left = value.as_s? || theme.footer_recto_left
        when "footer_recto_center" then theme.footer_recto_center = value.as_s? || theme.footer_recto_center
        when "footer_recto_right"  then theme.footer_recto_right = value.as_s? || theme.footer_recto_right
        when "footer_verso_left"   then theme.footer_verso_left = value.as_s? || theme.footer_verso_left
        when "footer_verso_center" then theme.footer_verso_center = value.as_s? || theme.footer_verso_center
        when "footer_verso_right"  then theme.footer_verso_right = value.as_s? || theme.footer_verso_right
          # Index
